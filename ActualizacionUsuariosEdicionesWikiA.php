...
$db = new mysqli('localhost', 'root', '');
  ...
  $db->select_db('tfgdatabase');
   ...
   $query = 'SELECT * FROM wikis where wikis.nombre_wiki like "A%" or  wikis.nombre_wiki like "B%" or wikis.nombre_wiki like "C%" or  wikis.nombre_wiki like "D%" or  wikis.nombre_wiki like "E%" or  wikis.nombre_wiki like "F%" or  wikis.nombre_wiki like "G%"';
