...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
					...
					<div class="col-md-3 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 5 Wikis users more files</h2>
											...
											<?php
													//EJEMPLO PARA TOP5 WIKIS CON + FICHEROS SUBIDOS
													 $query2 = 'SELECT * FROM wikis ORDER BY wikis.ficheros_subidos DESC LIMIT 5';
    ...
    <script>
		...
		<?php
						 ...
						 $query3 =  'SELECT * FROM wikis ORDER BY wikis.ficheros_subidos DESC LIMIT 10';
					  ...
					  $num_resultsListado3 = $result3->num_rows;
						$restarTotal =0;
						 ...
						 $row3 = $result3->fetch_object();
							$restarTotal = $restarTotal + $row3->ficheros_subidos;
							 echo '{
								 value: '.$row3->ficheros_subidos.',
								 name: "'.$row3->nombre_wiki.'"
							 },';
						 }
						$query4 =  'SELECT SUM(ficheros_subidos) as `asd` from `wikis`';
    ...
    xAxis: [
        {
			...
			<?php
			 ...
			 $query23 =  'SELECT * FROM wikis ORDER BY wikis.ficheros_subidos DESC LIMIT 10';
    ...
    series: [
        {
		  ...
		  $num_resultsListado23 = $result23->num_rows;
            ...
            markPoint: {
			 ...
			 $query232 =  'SELECT * FROM wikis ORDER BY wikis.ficheros_subidos DESC LIMIT 10';
