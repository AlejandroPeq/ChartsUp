            ...
            <div class="right_col" role="main">
					...
					<div class="col-md-5 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 10 Wikis with more admins</h2>
											...
											<?php
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p><strong>'.$row2->usuarios_administradores.'</strong> admin users</p>
				...
				<div class="col-md-7 col-sm-7 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h2>Wikis with more admin users on Wikia</h2>
						   ...
						   <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Top 10 Wikis with more admin users</h2>
					...
					<!--Buttons -->
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="x_content" style="background-image:url(images/ChartPanelPopup1.jpg); height:140px;">
                                            <h1 style="color:white; position:relative;   left: 4%; top: 30%;">Top 10 Wikis with more admin users</h1>
                                        </div>
                                        <div class="modal-body">
                                            <div style="padding:25px;">
                                                ...
                                                <p style=" text-align:justify;">
                                                    This list shows the 10 wikis with more admin users.<br>
													The list is sorted from highest to lowest number of admin users.<br>
													Each component of the list shows the number of administrators and the total number of registered users
												</p>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="x_content" style="background-image:url(images/ChartPanelPopup1.jpg); height:140px;">
                                            <h1 style="color:white; position:relative;   left: 4%; top: 30%;">Percentage of wikis with more admin users</h1>
                                        </div>
                                        <div class="modal-body">
                                            <div style="padding:25px;">
                                                <p style=" text-align:justify;     margin-top: 15%;">
                                                ...
                                                <p style=" text-align:justify;">
                                                    This graph shows the percentage of wikis (proportion) with more admin users.<br>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div style="padding:25px;">
                                                ...
                                                <p style=" text-align:justify;">
                                                    This panel shows the 10 wikis with more administrators.<br> 
													In this case it is a bar graph where each wiki has a different color.<br> 
													The X axis shows the wikis, and the Y axis shows the number of administrators.<br>
													The tooltip bar contains:<br>
													─ <b>Refresh</b> returns to the initial state.<br>
													─ <b>Save image</b> saves the graph in PNG format.
												</p>
