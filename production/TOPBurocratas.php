...
<body class="nav-md">
    ...
    <script>
		...
		<?php
						 ...
						 $query3 =  'SELECT * FROM wikis ORDER BY wikis.usuarios_burocratas DESC LIMIT 10';
					  ...
					  $num_resultsListado3 = $result3->num_rows;
						$restarTotal =0;
						 ...
						 $row3 = $result3->fetch_object();
							$restarTotal = $restarTotal + $row3->usuarios_burocratas;
							 echo '{
								 value: '.$row3->usuarios_burocratas.',
								 name: "'.$row3->nombre_wiki.'"
							 },';
						 }
						$query4 =  'SELECT SUM(usuarios_burocratas) as `asd` from `wikis`';
    ...
    xAxis: [
        {
			...
			<?php
			 ...
			 $query23 =  'SELECT * FROM wikis ORDER BY wikis.usuarios_burocratas DESC LIMIT 10';
    ...
    series: [
        {
		  ...
		  $num_resultsListado23 = $result23->num_rows;
			 ...
			 for( $i23 = 1; $i23 <= $num_resultsListado23; $i23++ ){
					$row23 = $result23->fetch_object();
					echo "$row23->usuarios_burocratas";
					if($i23 != $num_resultsListado23)
						echo ',';
				}
				?>
            ...
            markPoint: {
			 ...
			 $query232 =  'SELECT * FROM wikis ORDER BY wikis.usuarios_burocratas DESC LIMIT 10';
