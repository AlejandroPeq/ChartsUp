...
<head>
    ...
    <title>ChartsUp - Top Rollbacks </title>
...
<body class="nav-md">
                ...
                <div class="">
					...
					<div class="col-md-5 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 10 Wikis with more rollbacks</h2>
											...
											<?php
													//EJEMPLO PARA TOP5 WIKIS CON + FICHEROS SUBIDOS
													 $query2 = 'SELECT * FROM wikis ORDER BY wikis.usuarios_reversores DESC LIMIT 10';
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p><strong>'.$row2->usuarios_reversores.'</strong> rollback users</p>
					...
					<!-- Aquí está la segunda línea-->
						...
						<div class="col-md-7 col-sm-9 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Wikis with more rollback users on Wikia</h2>
							...
							<!-- Buttons -->
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="x_content" style="background-image:url(images/ChartPanelPopup1.jpg); height:140px;">
                                            <h1 style="color:white; position:relative;   left: 4%; top: 30%;">Top 10 Wikis with more rollback users</h1>
                                        </div>
                                        <div class="modal-body">
                                            <div style="padding:25px;">
                                                ...
                                                This list shows the 10 wikis with more rollback users.<br>
												The list is sorted from highest to lowest number of rollbacks.<br>
												Each component of the list shows the number of rollbacks and the total number of registered users   
												</p>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="x_content" style="background-image:url(images/ChartPanelPopup1.jpg); height:140px;">
                                            <h1 style="color:white; position:relative;   left: 4%; top: 30%;">Percentage of wikis with more rollbacks</h1>
                                        </div>
                                        <div class="modal-body">
                                            <div style="padding:25px;">
                                                <p style=" text-align:justify;     margin-top: 15%;">
                                                ...
                                                <p style=" text-align:justify;">
                                                This graph shows the percentage of wikis (proportion) with the highest number of rollbacks.<br>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div style="padding:25px;">
                                                ...
                                                <p style=" text-align:justify;">
                                                This panel shows the 10 wikis with more rollbacks.<br> 
													In this case it is a bar graph where each wiki has a different color.<br> 
													The X axis shows the wikis, and the Y axis shows the number of rollback users.<br>
													The tooltip bar contains:<br>
													─ <b>Refresh</b> returns to the initial state.<br>
													─ <b>Save image</b> saves the graph in PNG format.    
												</p>
    ...
    <script>
		...
		<?php
						 ...
						 $query3 =  'SELECT * FROM wikis ORDER BY wikis.usuarios_reversores DESC LIMIT 10';
					  ...
					  $num_resultsListado3 = $result3->num_rows;
						$restarTotal =0;
						 ...
						 $row3 = $result3->fetch_object();
							$restarTotal = $restarTotal + $row3->usuarios_reversores;
							 echo '{
								 value: '.$row3->usuarios_reversores.',
								 name: "'.$row3->nombre_wiki.'"
							 },';
						 }
						$query4 =  'SELECT SUM(usuarios_reversores) as `asd` from `wikis`';
    ...
    xAxis: [
        {
			...
			<?php
			 ...
			 $query23 =  'SELECT * FROM wikis ORDER BY wikis.usuarios_reversores DESC LIMIT 10';
    ...
    series: [
        {
		  ...
		  $num_resultsListado23 = $result23->num_rows;
			 ...
			 for( $i23 = 1; $i23 <= $num_resultsListado23; $i23++ ){
					$row23 = $result23->fetch_object();
					echo "$row23->usuarios_reversores";
					if($i23 != $num_resultsListado23)
						echo ',';
				}
				?>
            ...
            markPoint: {
			 ...
			 $query232 =  'SELECT * FROM wikis ORDER BY wikis.usuarios_reversores DESC LIMIT 10';
