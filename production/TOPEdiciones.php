            ...
            <div class="right_col" role="main">
					...
					<div class="col-md-3 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 5 Wikis users more editions</h2>
											...
											<?php
													//EJEMPLO PARA TOP5 WIKIS CON + FICHEROS SUBIDOS
													 $query2 = 'SELECT * FROM wikis ORDER BY wikis.ediciones_paginas DESC LIMIT 5';
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p><strong>'.$row2->ediciones_paginas.'</strong> ediciones</p>
						   ...
						   <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>The 10 Wikis with most editions</h2>
					...
					<!-- Aquí está la segunda línea-->
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Graphic editions on Wikia</h2>
                                    <!--<ul class="nav navbar-right panel_toolbox">
