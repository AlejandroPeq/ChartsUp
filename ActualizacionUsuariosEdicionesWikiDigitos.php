...
$db = new mysqli('localhost', 'root', '');
  ...
  $db->select_db('tfgdatabase');
   ...
   $query = 'SELECT * FROM wikis where wikis.nombre_wiki like "0%" or  wikis.nombre_wiki like "1%" or wikis.nombre_wiki like "2%" or  wikis.nombre_wiki like "3%" or  wikis.nombre_wiki like "4%" or  wikis.nombre_wiki like "5%" or  wikis.nombre_wiki like "6%" or  wikis.nombre_wiki like "7%" or  wikis.nombre_wiki like "8%" or  wikis.nombre_wiki like "9%"';
